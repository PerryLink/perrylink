...
![repos](https://img.shields.io/badge/repos-196-green)
![stars](https://img.shields.io/badge/stars-1293-yellow)
...
- **GitHub** (this profile) — source, CI, releases; **1,293★ across all 196 public repos, 1,222★ of it in the 46-repo family** (41 plugins + 5 support repos; the 45 PerryLink-owned ones are 1,214★, the other 8★ is [pan17/dsh-wechat](https://github.com/pan17/dsh-wechat)), 44 of the PerryLink-owned repos declaring the `dsh.bundle` contract and 41 of the 45 carrying five-language docs
